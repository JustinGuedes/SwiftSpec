...
/// Specification to allow two specifications to be or-ed together and will be satisfied if any specification is
/// satisfied.
public struct OrSpecification<FirstSpec: Specification, SecondSpec: Specification>: Specification
