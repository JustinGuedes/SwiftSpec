#
# Be sure to run `pod lib lint SwiftSpec.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'SwiftSpec'
  s.version          = '0.1.0'
  s.summary          = 'A short description of SwiftSpec.'
...
TODO: Add long description of the pod here.
  ...
  s.source_files = 'SwiftSpec/Classes/**/*'
  
  # s.resource_bundles = {
  #   'SwiftSpec' => ['SwiftSpec/Assets/*.png']
  # }
